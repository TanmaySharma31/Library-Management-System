...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT StudentId FROM tblstudents WHERE StudentId=:studentid and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblstudents set Password=:newpassword where StudentId=:studentid and MobileNumber=:mobile";
...
echo "<script>alert('Student ID or Mobile no is invalid');</script>"; 
}
}
?>
<!DOCTYPE html>
